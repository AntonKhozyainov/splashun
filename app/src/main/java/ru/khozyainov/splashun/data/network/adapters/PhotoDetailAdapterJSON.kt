...
import ru.khozyainov.splashun.models.Exif
import ru.khozyainov.splashun.models.Location
import ru.khozyainov.splashun.models.PhotoDetails

class PhotoDetailAdapterJSON {

    @FromJson
    fun fromJson(photoDetailRemote: PhotoDetailRemote): PhotoDetails =
        PhotoDetails(
    ...
    @ToJson
    fun toJson(photoDetails: PhotoDetails): PhotoDetailRemote = PhotoDetailRemote(
        id = photoDetails.id,
